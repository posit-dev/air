...
# TODO: Piping into a ggplot2 `+` chain works nicely because of how
# precendence rules naturally work, but piping OUT of a ggplot2 `+`
# chain creates this extra indent. Do we want to support this?
ggplot() +
	geom_line() +
	geom_bar() %>%
		identity()
