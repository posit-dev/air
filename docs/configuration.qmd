...
The easiest way to configure a project to use Air with the recommended settings is to use `use_air()` from [{usethis}](https://github.com/r-lib/usethis).
Note that you currently need the development of the usethis package version installed.
