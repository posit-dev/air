...
The easiest way to do this is by running [`usethis::use_air()`](https://github.com/r-lib/usethis) (note that this currently requires the development version of usethis).
