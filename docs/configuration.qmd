...
With VS Code and Positron, downloading the [Even Better TOML](https://marketplace.visualstudio.com/items?itemName=tamasfe.even-better-toml) extension activates autocompletion and validation while inside an `air.toml` file.
...
{{< video videos/air-toml-autocompletions.mov >}}

If your IDE supports [schemastore](https://github.com/SchemaStore/schemastore), then it may also support autocompletion and validation of `air.toml` files.
